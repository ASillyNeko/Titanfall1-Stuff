...
void function CreateGamemodeCampaign()
{
    ...
    GameMode_SetDefaultTimeLimits( GAMEMODE_CAMPAIGN_CAROUSEL, 10, 0 )
    GameMode_SetDefaultScoreLimits( GAMEMODE_CAMPAIGN_CAROUSEL, 1, 0 )
    GameMode_AddScoreboardColumnData( GAMEMODE_CAMPAIGN_CAROUSEL, "#SCOREBOARD_SCORE", PGS_ASSAULT_SCORE, 2 )
